...
fun getOperationTimeOfWeek(storeDetailModel: StoreDetailModel): Map<String, List<String>> {
...
fun getOperatingType(regularOpeningHours: List<OpeningHoursModel>): OperatingTime {
